      ...
      .addComponents(
        new MessageSelectMenu()
          ...
          .addOptions([
            {
              label: 'Tam Yetki',
              description: 'Tam Yetkide Eklersiniz',
              value: 'Full',

            },
            {
              label: 'Rol ve Kanal',
			   description: 'Rol ve Kanal Yetkisinde Eklersiniz',
              value: 'Role&Channel',
            },
            {
              label: 'Rol',
			  description: 'Rol Yetkisinde Eklersiniz',
              value: 'Role',
            },
            {
              label: 'Kanal',
			  description: 'Kanal Yetkisinde Eklersiniz',
              value: 'Channel',
            },

            {
              label: 'Ban & Kick',
			  description: 'Sağ Tık Ban & Kick Yetkisinde Eklersiniz',
              value: 'Ban&Kick',
            },

            {
              label: 'Bot Ekleme',
			  description: 'Bot Ekleme Yetkisinde Eklersiniz',
              value: 'Bot',
            },
            {
              label: 'Everyone',
			   description: 'Everyone Atma Yetkisinde Eklersiniz',
              value: 'Chat',
            },
            {
              label: 'Sekme',
			  description: 'Sekme Koruma Yetkisinde Eklersiniz',
              value: 'Sekme',
            },
            {
              label: 'Safe Rol',
			  description: 'Güvenli Rol Yetkisinde Eklersiniz',
              value: 'Saferole',
            },
